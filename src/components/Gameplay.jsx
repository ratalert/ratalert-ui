...
class Gameplay extends React.Component {
  constructor(props) {
    ...
    this.gameplayRef = React.createRef();
  }
  ...
  renderGameplay() {
    ...
    return (
      <div className="main whitepaper" ref={this.gameplayRef} style={{borderRadius: 30, border: '1px solid #CCCCCC', background: '#F5F5F5', marginLeft: 20, marginRight: 20, marginBottom: 20}}>
